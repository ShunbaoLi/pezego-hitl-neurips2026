...
This folder contains a lightweight reproducibility package for the paper:
...
Replace the placeholder with your final public or anonymous repository URL:

- Code URL: https://github.com/<org-or-user>/pezego-hitl-neurips2026
...
- Figure 3: main comparison (`figures/fig03_main_comparison.png`)
- Figure 4: latency distribution (`figures/fig04_latency_distribution.png`)
- Figure 5: HITL trend (`figures/fig05_hitl_trend.png`)
- Figure 6: tau ablation (`figures/fig06_tau_ablation.png`)
- Figure 7: user profile (`figures/fig07_user_profile.png`)
...
git branch -M main
git remote add origin https://github.com/<org-or-user>/pezego-hitl-neurips2026.git
git push -u origin main
```

Your code URL will be:

- `https://github.com/<org-or-user>/pezego-hitl-neurips2026`
